...
public class WaterBill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e1=findViewById(R.id.editTextNumber7);
        e2=findViewById(R.id.editTextNumber8);
        s1=findViewById(R.id.spinner4);
        b1=findViewById(R.id.button8);
        ib1=findViewById(R.id.imageButton16);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,R.array.board1, android.R.layout.simple_spinner_item);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    boolean r1 = obj1.insert(ph, a1, "", a2, "water bill",currentDate+" "+currentTime);
                    if (r1 == true) {
        ...
        ib1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1=new Intent(WaterBill.this,RechargeAndBillPayments.class);
                startActivity(i1);
            }
        });
    }

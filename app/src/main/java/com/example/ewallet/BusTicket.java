...
public class BusTicket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib1=findViewById(R.id.imageButton23);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    boolean r1 = obj1.insert(ph, a1, "", a2, "Bus Ticket",currentDate+" "+currentTime);
                    if (r1 == true) {
        ...
        ib1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1= new Intent(BusTicket.this,TicketBooking.class);
                startActivity(i1);
            }
        });
    }

...
public class DthRecharge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib1=findViewById(R.id.imageButton14);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,R.array.providers, android.R.layout.simple_spinner_item);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    boolean r1 = obj1.insert(ph, a1, "", a2, "dth recharge",currentDate+" "+currentTime);
                    if (r1 == true) {
        ...
        ib1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1=new Intent(DthRecharge.this,RechargeAndBillPayments.class);
                startActivity(i1);
            }
        });
    }
